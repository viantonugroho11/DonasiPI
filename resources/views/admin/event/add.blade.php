              ...
              <div class="card card-info">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                        <input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" placeholder="Masukan Nama Event">
                    ...
                    <div class="form-group">
                        ...
                        <input name="tgl_pelaksaan" type="date" class="form-control @error('tgl_pelaksaan') is-invalid @enderror" value="{{ old('tgl_pelaksaan') }}" placeholder="Masukan Tanggal Pelaksanaan">
                    ...
                    <div class="form-group">
                        ...
                        {{-- <div class="input-group date" id="reservationdate" data-target-input="nearest"> --}}
                            <input name="bts_daftar" type="date" class="form-control @error('bts_daftar') is-invalid @enderror" value="{{ old('bts_daftar') }}" placeholder="Masukan Nominal">
                    ...
                    <div class="form-group">
                        ...
                        <input name="bts_peserta" type="number" class="form-control @error('bts_peserta') is-invalid @enderror" value="{{ old('bts_peserta') }}" placeholder="Batas Peserta">
