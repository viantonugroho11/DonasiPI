          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="{{ route('kategori.create') }}" class="btn btn-md btn-success" style="margin-bottom: 10px">+ TAMBAH DATA</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @forelse ($kategori as $data)
                    <tr>
                      <td>{{ $data->id }}</td>
                      <td>{{ $data->nama }}</td>
                      <td><img src="{{ Storage::url('public/PhotoKategori/').$data->icon }}" width="100px" height="100px"></td>
                      <td>
