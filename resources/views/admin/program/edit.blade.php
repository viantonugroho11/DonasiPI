...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <form role="form" action="{{ route('program.update',$program->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                        <input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama',$program->nama) }}" placeholder="Masukan Nama Jurusan">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nominal" type="number" class="form-control @error('nominal') is-invalid @enderror" value="{{ old('nominal',$program->nominal) }}" placeholder="Masukan Nominal">
                    ...
                    <div class="form-group">
                        ...
                        <input name="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal',$program->batas) }}" placeholder="Masukan Nominal">
                    </div>
                    {{-- Upload Gambar --}}
                    <div class="form-group">
